...
big_font = pygame.font.Font('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/font/myFont.ttf', 60)
WIDTH = 900
HEIGHT = 800
...
two_coords = [[], [], []]
three_coords = [[], [], [], []]
menu_img = pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/menus/mainMenu.png')
game_over_img = pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/menus/gameOver.png')
pause_img = pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/menus/pause.png')
for i in range(1, 4):
    ...
    guns.append(pygame.transform.scale(pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/guns/{i}.png'), (100, 100)))
    if i < 3:
        for j in range(1, 4):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/targets/{i}/{j}.png'), (120 - (j * 18), 80 - (j * 12))))
    else:
        for j in range(1, 5):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f'C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/targets/{i}/{j}.png'), (120 - (j * 18), 80 - (j * 12))))
file = open('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/high_scores.txt', 'r')
...
pygame.mixer.init()
pygame.mixer.music.load('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/sounds/bg_music.mp3')
plate_sound = pygame.mixer.Sound('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/sounds/Broken plates.wav')
plate_sound.set_volume(.2)
bird_sound = pygame.mixer.Sound('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/sounds/Drill Gear.mp3')
bird_sound.set_volume(.2)
laser_sound = pygame.mixer.Sound('C:/Users/SMITH/Desktop/gitpython/ShootingGallery/assets/sounds/Laser Gun.wav')
